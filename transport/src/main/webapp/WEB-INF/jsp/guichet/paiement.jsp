              ...
              <article class="passenger-card">
                <div class="passenger-form-grid">
                  ...
                  <label class="field">
                    ...
                    <input name="montant" class="field-input" type="number" placeholder="Ex. Rakoto Andrianina" />
                  </label>
                  ...
                  <label class="field field-span-2">
                    ...
                    <input name="reference" class="field-input" type="text" placeholder="12 chiffres" />
                  </label>
                </div>
              </article>
            </div>
        ...
        <aside class="summary-col">
          <div class="summary-card">
            ...
            <div>
              ...
              <div><p class="summary-item-label">Sièges</p><div class="selected-list"><span class="selected-seat">6</span></div></div>
              <div class="summary-divider"></div>
