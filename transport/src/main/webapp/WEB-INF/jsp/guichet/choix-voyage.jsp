...
<html lang="fr">
  <head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/guichet/choix-voyage.css" />
  </head>
  <body>
    <div class="app-shell">
      <header class="topbar">
              ...
              <c:forEach var="voyage" items="${voyages}">
                <article class="trip-card">
                  <div class="trip-operator">
                    ...
                    <div>
                      <p class="trip-operator-name">KOP-V ${voyage.categorieVehicule}</p>
                      <p class="trip-operator-meta">Véhicule à ${voyage.nbPlacesTotales} places</p>
                    </div>
                  </div>
