...
public class StatistiqueService {
    ...
    // ========================================
    public StatistiqueJournaliereDTO getStatsJournaliere(LocalDate date) {
        StatistiqueJournaliereDTO stats = new StatistiqueJournaliereDTO();
        stats.setDate(date);
    ...
    // ========================================
    public StatistiqueMensuelleDTO getStatsMensuelle(int annee, int mois) {
        StatistiqueMensuelleDTO stats = new StatistiqueMensuelleDTO();
