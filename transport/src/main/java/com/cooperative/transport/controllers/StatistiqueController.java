...
public class StatistiqueController {
    ...
    public String getStatsJournaliere(
        ...
        StatistiqueJournaliereDTO stats = statistiqueService.getStatsJournaliere(jour);
    ...
    public String getStatsMensuelle(
        ...
        StatistiqueMensuelleDTO stats = statistiqueService.getStatsMensuelle(annee, mois);
