...
@Repository
public interface ContratEmployeRepository extends JpaRepository<ContratsEmployes, Integer> {
    ...
    ContratsEmployes findTopByEmployeIdOrderByDateEmbaucheDesc(Integer id);
}
