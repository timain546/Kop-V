...
CREATE TABLE
    point_ramassage (id SERIAL PRIMARY KEY, nom VARCHAR(150) NOT NULL);
...
INSERT INTO
    reparation (
        id_panne,
        id_statut_reparation,
        cout,
        date_modification
    )
VALUES
    (1, 1, 0, '2026-07-01 08:30:00'),
    (2, 2, 150000, '2026-07-02 10:15:00'),
    (3, 3, 350000, '2026-07-03 16:45:00'),
    (4, 1, 0, '2026-07-04 09:00:00'),
    (5, 2, 200000, '2026-07-05 14:20:00'),
    (6, 3, 500000, '2026-07-06 11:30:00'),
    (7, 2, 175000, '2026-07-07 15:00:00'),
    (8, 3, 450000, '2026-07-08 17:10:00');
...
VALUES
    (
        ...
        'RN7 - Antsirabe',
        1,
        'Problème moteur : perte de puissance pendant le trajet',
        'photos/moteur1.jpg'
    ),
    (
        2,
        4,
        '2026-07-02 10:15:00',
        'Gare routière Antananarivo',
        2,
        'La batterie ne fonctionne plus correctement',
        'photos/electrique1.jpg'
    ),
    (
        3,
        3,
        ...
        'RN4 - Mahajanga',
        3,
        'Pneu arrière crevé pendant le voyage',
        NULL
    ),
    (
        4,
        ...
        'Fianarantsoa',
        4,
        'Problème inconnu détecté sur le véhicule',
        NULL
    );